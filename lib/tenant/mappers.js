...
export const mapTenant = (t) => ({
  ...
  email: t.email,
  phone: t.phone || "",
  // Optional, and normalized on read so a legacy or hand-edited value ("Male")
  // resolves to the vocabulary instead of silently drawing no mark.
  ...
  // Landlord confirmation that the move actually happened. Null keeps the
  // transition on the dashboard — see awaitingMoveInAck/awaitingMoveOutAck.
  moveInAckedAt: t.move_in_acked_at || null,
  moveOutAckedAt: t.move_out_acked_at || null,
