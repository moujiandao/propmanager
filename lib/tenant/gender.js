...
// parking module uses for `type` vs `market_status`: the app only ever
// *displays* gender, it never *dispatches* on it. Values you branch on want a
// database constraint; values you render want the freedom to grow without a
// migration. Adding a third option is a one-line change here.
//
