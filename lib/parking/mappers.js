...
export const mapParkingSpot = (s) => ({
  ...
  type: s.type || "",
  // Vehicle parked in this spot. Attached to the spot, not the lease -- see
  // scripts/add-parking-spot-car.sql for that tradeoff.
  carMake: s.car_make || "",
  carModel: s.car_model || "",
  carYear: s.car_year ?? null,
