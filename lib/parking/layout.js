...
// sense: 90° is head-in, and smaller is more acute, so 30° stalls lean harder
// than 45° ones did. This is the one number to change to re-angle the bank.
const BAY_ANGLE_DEG = 30;
...
// depth / tan(angle) -- equal to the depth at 45°, but 1.73× it at 30°. That
// climb is height the bays cannot share as pitch, which is why a more acute
// angle costs the lot real length.
