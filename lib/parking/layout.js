...
const OUTLINE = { x: 10, y: 70, w: 400, h: 426 };
...
// the wall. Matches the straight column's width, since both hold one car end to
// end; it also narrows the aisle between the two banks, which is otherwise the
// widest thing in the lot.
const RIGHT_DEPTH = 90;
