...
export const T = {
  en: {
    ...
    tabTemplates: "Templates", tabEmailGenerator: "Email Generator", tabAutomations: "Automations", tabInbox: "Inbox",
    generatorIntro: "Build one template, enter each bill in the table, then generate personalized emails to copy.",
    generatorNeverSends: "This generator never sends email. It only creates text you can copy.",
    generatorSubject: "Email subject", generatorBody: "Email body",
    generatorDefaultSubject: "PG&E reimbursement for unit {unit_number}: {month_year}",
    generatorDefaultBody: "Hi {name}\n\nThere are PG&E bills from last year for unit {unit_number} that we paid on your behalf:\n\n{bill_lines}\n\nTotal: ${amount}\n\nCan you send a Zelle payment with the memo \"unit {unit_number} pge {month_year}\" at your earliest convenience?\n\nIf you have not done so already, please ensure your PG&E account is set up with your current address and unit number.\n\nThank you,\nBrian",
    generatorFieldName: "Tenant first names", generatorFieldUnit: "Unit number",
    generatorFieldMonth: "Month and year", generatorFieldAmount: "Total amount", generatorFieldBillLines: "Bill line items",
    generatorUnit: "Unit", generatorNames: "Name(s)", generatorMonth: "Month and year", generatorAmount: "Amount",
    generatorSelectUnit: "Select a unit...", generatorNoTenants: "No tenants occupied this unit during this month.",
    generatorEnterUnitMonth: "Select a unit and month.", generatorAddRow: "Add row", generatorRemoveRow: "Remove row",
    generatorGenerate: "Generate emails", generatorCompleteRows: "Complete the unit, month, and amount for every row.",
    generatorResults: "Generated emails", generatorCopySubject: "Copy subject", generatorCopyBody: "Copy email",
    generatorEmailAddresses: "Tenant email addresses", generatorCopyEmails: "Copy email addresses",
    generatorNoEmailAddresses: "No email addresses available.", generatorCopied: "Copied", generatorCopyFailed: "Could not copy to the clipboard.",
    generatorMissingEmails: (names) => `Missing an email address for: ${names}.`,
  ...
  zh: {
    ...
    tabTemplates: "模板", tabEmailGenerator: "邮件生成器", tabAutomations: "自动化规则", tabInbox: "收件箱",
    generatorIntro: "创建一个模板，在表格中输入每笔账单，然后生成可复制的个性化邮件。",
    generatorNeverSends: "此生成器绝不会发送邮件，只会生成可复制的文字。",
    generatorSubject: "邮件主题", generatorBody: "邮件正文",
    generatorDefaultSubject: "{unit_number} 单元 PG&E 费用报销：{month_year}",
    generatorDefaultBody: "您好 {name}，\n\n我们代为支付了 {unit_number} 单元去年的以下 PG&E 账单：\n\n{bill_lines}\n\n总计：${amount}\n\n请您尽早通过 Zelle 转账，并在备注中填写 \"unit {unit_number} pge {month_year}\"。\n\n如果尚未设置，请确保您的 PG&E 账户使用当前地址和单元号码。\n\n谢谢，\nBrian",
    generatorFieldName: "租户名字", generatorFieldUnit: "单元号码",
    generatorFieldMonth: "月份和年份", generatorFieldAmount: "总金额", generatorFieldBillLines: "账单明细",
    generatorUnit: "单元", generatorNames: "姓名", generatorMonth: "月份和年份", generatorAmount: "金额",
    generatorSelectUnit: "选择单元...", generatorNoTenants: "该月份没有租户居住在此单元。",
    generatorEnterUnitMonth: "请选择单元和月份。", generatorAddRow: "添加一行", generatorRemoveRow: "删除此行",
    generatorGenerate: "生成邮件", generatorCompleteRows: "请填写每一行的单元、月份和金额。",
    generatorResults: "生成的邮件", generatorCopySubject: "复制主题", generatorCopyBody: "复制邮件",
    generatorEmailAddresses: "租户邮箱地址", generatorCopyEmails: "复制邮箱地址",
    generatorNoEmailAddresses: "没有可用的邮箱地址。", generatorCopied: "已复制", generatorCopyFailed: "无法复制到剪贴板。",
    generatorMissingEmails: (names) => `以下租户缺少邮箱地址：${names}。`,
